...
## 0x0F [CVE-2026-29145](https://github.com/gregk4sec/CVE-2026-29145) - Tomcat <Confidential>
|Date|Status|Comment|
|:--:|:--:|:--:|
|Feb 02, 2026|Private|Reported to Tomcat security team|
|Mar 05, 2026|Private|Confirmed with CVE-2026-29145|

## 0x0E [CVE-2026-25854](https://github.com/gregk4sec/CVE-2026-25854) - Tomcat <Confidential>
|Date|Status|Comment|
|:--:|:--:|:--:|
|Jan 30, 2026|Private|Reported to Tomcat security team|
|Feb 06, 2026|Private|CVE-2026-25854 confirmed|
...
```bash
curl -i --path-as-is "https://<XXX>.execute-api.*********.am*******.com/prod/public-api/health/<CRAFTED_URI>/<admin-api>/conf/secret.xml"
```

**WHAT HE CAN DO?**

```bash
curl -i --path-as-is "https://<XXX>.execute-api.*********.am*******.com/prod/public-api/health/<CRAFTED_URI>/manager/html/"
# → SC 200
```
...
## 0x0B [CVE-2026-21962](https://github.com/gregk4sec/CVE-2026-21962) - Oracle Fusion OHS Path Traversal
|Date|Status|Comment|
|:--:|:--:|:--:|
|Nov 11, 2025|Private|Reported to Oracle security team|
|Nov 13, 2025|Private|Behavior confirmed|
|Jan 15, 2026|Private|CVE-2026-21962 confirmed|
|Jan 15, 2026|Private|Fixed in Oracle Jan2026CPU|
...
## 0x06 [CVE-2025-9498](https://github.com/gregk4sec/TBD) - Bugzilla - TBD
|Date|Status|Comment|
|:--:|:--:|:--:|
